...
@register_model_architecture('lightconv', 'arclc-a')
def arclc_a(args):
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', None)
    ...
    args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [63, 127, 127, 255, 255])
    # args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [7, 15, 31, 31, 31])
    # args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [3, 7, 15, 31, 31, 31, 31])

    args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [63, 127, 127, 255, 255])
    # args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [7, 15, 31, 31, 31])
    # args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [3, 7, 15, 31, 31, 31])
...
def arclc_b(args):
    ...
    # args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [15, 31, 63, 127, 255])
    # args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [15, 31, 63, 127, 255])
    args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [63, 63, 127, 127, 255])
    args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [63, 63, 127, 127, 255])
    arclc_a(args)

@register_model_architecture('lightconv', 'arclc-c')
def arclc_c(args):
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', None)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 512)
    ...
    args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [63, 63, 63, 63, 127, 127, 255])
    args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [63, 63, 63 ,127, 127, 255])
    # args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [127, 127, 127, 127, 255, 255, 255])
    # args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [127, 127, 127, 127, 255, 255, 255])
    arclc_a(args)
...
#     args.encoder_layers = getattr(args, 'encoder_layers', 4)
#     args.encoder_attention_heads = getattr(args, 'enqcoder_attention_heads', 16)
#     args.encoder_normalize_before = getattr(args, 'encoder_normalize_before', False)
#     args.encoder_learned_pos = getattr(args, 'encoder_learned_pos', False)
#     args.decoder_embed_path = getattr(args, 'decoder_embed_path', None)
#     args.decoder_layers = getattr(args, 'decoder_layers', 4)
...
#     args.encoder_kernel_size_list = getattr(args, 'encoder_kernel_size_list', [255, 255, 255, 255])
#     args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [255, 255, 255, 255])
#     arclc_a(args)
