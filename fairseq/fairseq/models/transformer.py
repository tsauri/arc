...
DEFAULT_MAX_SOURCE_POSITIONS = int(1e5)
DEFAULT_MAX_TARGET_POSITIONS = int(1e5)
...
@register_model_architecture("transformer", "arcvt-a")
def arc_a(args):
    args.encoder_embed_path = getattr(args, "encoder_embed_path", None)
...
@register_model_architecture("transformer", "arcvt-b")
def arc_b(args):
    ...
    args.decoder_ffn_embed_dim = getattr(
        args, "decoder_ffn_embed_dim", 64
    )
    args.decoder_layers = getattr(args, "decoder_layers", 5)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 8)
    args.decoder_output_dim = getattr(
        args, "decoder_output_dim", 8
    )
    args.decoder_input_dim = getattr(args, "decoder_input_dim", 8)
    arc_a(args)
